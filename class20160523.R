...
- Inputs: Numeric
- Output: Categorical, 2 class labels ##有得糖尿病跟沒得糖尿病
##參數:懷孕幾次、血糖濃度、血壓、蝴蝶袖捏起來一把有多厚(皮下脂肪)、
##     胰島素的量、BMI、家族病史、年紀
##先安裝這個package
...
## 資料介紹: 乳癌資料集(類別)
1. Sample code number: id number ##不用拿來做training，要拿掉
...
# 看一下 Training set : Test set 病人數(1/3是test的，2/3是training的)
